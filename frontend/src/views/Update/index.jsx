...
import "./index.scss";
function index() {
  // actores, titulo, año, director, reseña, src, portada
  const { id } = useParams();
  ...
  const handleSubmit = (e) => {
    console.log(video);
    e.preventDefault();
    axios.patch(`http://localhost:4000/trailer/${id}`, { trailer: video }).then(res => {
      navigate("/admin");
    });
  };
